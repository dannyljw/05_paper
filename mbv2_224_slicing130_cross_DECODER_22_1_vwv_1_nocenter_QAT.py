...
from def_224_diet_decoder22_1_vwv_1_nocenter import MobileNetV2 as torch_mobilenet_v2_branch
#seed
...
class LitQAModel(pl.LightningModule):
    def __init__(self, checkpoint_path=None):
        ...
        self.model = QuantizedMobileNetV2(num_classes=2, checkpoint_path=checkpoint_path)
    ...
    def train_dataloader(self):
        train_image_preprocess = transforms.Compose([
            transforms.Resize((66,66)), # 80x80
            transforms.RandomHorizontalFlip(),
            transforms.ColorJitter(brightness=0.4, contrast=0.4, saturation=0.4, hue=0.4),
            transforms.RandomRotation(20),
            transforms.ToTensor(),
            transforms.RandomCrop((66,66)),
...
checkpoint_path = "/workspace/3.MyModel/05_paper/mbv2_224_slicing130_cross_DECODER_22_1_vwv_1_nocenter-epoch=90.ckpt"
