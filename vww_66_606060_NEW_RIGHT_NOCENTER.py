...
from def_224_diet_decoder22_1_vwv_NEWRIGHT_NOCENTER import MobileNetV2 as torch_mobilenet_v2_branch
#seed
...
class LitModel(pl.LightningModule):
    def __init__(self):
        ...
        self.model = torch_mobilenet_v2_branch(num_classes=2)
...
call_back = pl.callbacks.ModelCheckpoint(
    ...
    filename=str(__file__).split('.')[0]+"-{epoch:02d}-{val_acc:.4f}",
)
trainer = pl.Trainer(
    accelerator="gpu",
    strategy="ddp",
