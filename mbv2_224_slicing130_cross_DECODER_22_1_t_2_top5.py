...
class LitModel(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        self.log('val_top5_acc', self.val_top5_acc.compute(), sync_dist=True)
...
checkpoint_path = "/workspace/3.MyModel/torch_lite_famous_first/checkpoint/mbv2_224_slicing130_cross_DECODER_22_1_t_2-epoch=207.ckpt"
